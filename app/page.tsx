...
export default function Page() {
  ...
  return (
    <div className='min-h-screen'>
      ...
      {/* Hero section, services, packages, etc. – same as before */}
        ...
        <Card className='p-6'>
          <form onSubmit={handleSubmit} className='grid gap-4 md:grid-cols-2'>
            <div>
              ...
              <input name='name' required className='w-full rounded-xl border border-white/20 bg-white/5 p-2'/>
            </div>
            <div>
              <label className='block text-sm mb-1'>Email</label>
              <input type='email' name='email' required className='w-full rounded-xl border border-white/20 bg-white/5 p-2'/>
            </div>
            <div className='md:col-span-2'>
              <label className='block text-sm mb-1'>Project Details</label>
              <textarea name='message' rows={6} className='w-full rounded-xl border border-white/20 bg-white/5 p-2'/>
            </div>
